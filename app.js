...
app.post("/login", (req, res)=> {
 ...
 //end of connection.query()
   ...
   app.post("/book_appointment", (req, res)=> {
    ...
    const sqlInser1 = "INSERT INTO userTable VALUES (0,?,?,?)"
    const insert_query1 = mysql.format(sqlInser1,[cus_name, cus_email, cus_no]);
    ...
    connection.query(insert_query, (err, result) => {
        ...
        connection.query(insert_query1, (err, result) => {
            if (err){
                throw (err);
            }
            console.log("--------> Created new User");
